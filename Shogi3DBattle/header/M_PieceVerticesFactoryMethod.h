...
class M_PieceVerticesFactoryMethod
{
public:
    std::unique_ptr<Vertices> GetPieceVertices(float mmBottomWidth, float mmHeight); // 駒の頂点集合作成
};

// 駒の頂点集合作成
std::unique_ptr<Vertices> M_PieceVerticesFactoryMethod::GetPieceVertices(float mmBottomWidth, float mmHeight)
{
