...
{
private:
    std::vector<std::vector<I_Piece*>> _piecePlacedOnBoard;      // 将棋盤上の駒の位置を記憶する変数
    std::vector<std::vector<I_Piece*>> _piecePlacedOnSideBoard1; // 将棋盤上の駒の位置を記憶する変数
    std::vector<std::vector<I_Piece*>> _piecePlacedOnSideBoard2; // 将棋盤上の駒の位置を記憶する変数
